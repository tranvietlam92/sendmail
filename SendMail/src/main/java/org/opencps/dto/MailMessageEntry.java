...
import org.opencps.utils.ConfigurationUtils;
...
//	}
	...
	public MailMessageEntry(String fromName, long toUserId, String toEmail, String toName, long userId, long groupId,
			long companyId) {
		...
		this.setFrom(initInternetAddress(props.getProperty("mail.admin.server"), fromName));
